			...
			<div className="flex-1 flex min-h-0 overflow-hidden justify-center">
				...
				>
							...
							{appLoading ? (
								...
								<>
									...
									{import.meta.env
										...
										<div className="flex justify-between items-center py-2 border-b border-neutral-300 dark:border-neutral-700 mb-4">
											<AgentModeDisplay
												mode={
													agentMode as
														| 'deterministic'
					...
					<div className="relative">
						{isChatDragging && (
							<div className="absolute inset-0 flex items-center justify-center bg-accent/10 backdrop-blur-sm rounded-[0.625rem] z-50 pointer-events-none">
						...
						<textarea
							...
							onChange={(e) => {
								...
								rows={1}
								className="w-full bg-white dark:bg-bg-2 border border-neutral-300 dark:border-neutral-700 rounded-[0.625rem] px-3 pr-20 py-2 text-sm outline-none focus:border-accent focus:ring-2 focus:ring-accent/30 shadow-sm text-text-primary placeholder:text-neutral-400 dark:placeholder:text-neutral-500 disabled:opacity-50 disabled:cursor-not-allowed resize-none overflow-y-auto no-scrollbar min-h-[36px] max-h-[120px]"
								style={{
							...
							<div className="absolute right-1.5 bottom-2.5 flex items-center gap-1">
								<button
									...
									className="p-1.5 rounded-[0.625rem] hover:bg-neutral-100 dark:hover:bg-bg-3 text-text-secondary hover:text-text-primary transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
								...
								<button
									...
									className="p-1.5 rounded-[0.625rem] bg-accent hover:bg-accent/90 disabled:opacity-50 disabled:cursor-not-allowed disabled:bg-transparent text-white disabled:text-text-primary transition-colors"
								>
				...
				<AnimatePresence>
					...
					>
							{view === 'preview' && previewUrl && (
								<div className="flex-1 flex flex-col bg-white dark:bg-bg-2 rounded-[0.625rem] shadow-md overflow-hidden border border-neutral-300 dark:border-neutral-700">
									<div className="grid grid-cols-3 px-2 h-10 border-b border-neutral-300 dark:border-neutral-700 bg-neutral-50 dark:bg-bg-3">
										...
										<div className="flex items-center justify-center">
											<div className="flex items-center gap-2">
												...
												<button
													className="p-1 hover:bg-neutral-100 dark:hover:bg-bg-2 rounded-[0.375rem] transition-colors"
													onClick={() => {

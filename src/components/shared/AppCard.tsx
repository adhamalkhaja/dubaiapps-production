		...
		return (
			...
			>
				...
				>
					<Card
						className={cn(
							'h-full transition-all duration-300 ease-out cursor-pointer group relative overflow-hidden rounded-[0.625rem] p-2 bg-white dark:bg-bg-2 hover:!bg-neutral-50 dark:hover:!bg-bg-3',
							'border border-neutral-300 dark:border-neutral-700 hover:border-accent',
						)}
					>
					{/* Enhanced Preview Section with High-Quality Rendering */}
					<div className="relative aspect-[16/9] rounded-[0.625rem] overflow-hidden bg-gradient-to-br from-neutral-50 to-neutral-100 dark:from-neutral-900/20 dark:to-neutral-800/20">
						{app.screenshotUrl ? (
							<img
								...
								<div className="flex items-center gap-3">
									...
									{app.githubRepositoryUrl &&
										app.githubRepositoryVisibility !==
											'private' && (
											<button
												className="group/github flex items-center gap-1.5 px-2 py-1 rounded-full bg-neutral-100 hover:bg-neutral-200 dark:bg-neutral-800 dark:hover:bg-neutral-700 border border-neutral-300 dark:border-neutral-700 hover:border-accent transition-all duration-200"
												onClick={(e) => {
													e.stopPropagation();
													if (
														app.githubRepositoryUrl
